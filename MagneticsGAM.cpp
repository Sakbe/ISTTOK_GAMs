...
//we can try with if(this->numFilament == 12) {} else if(numFilament==7) {}	
 ...
 /*		OLD CENTROID CALCULATION
		...
		//	vertical_position += ADC_WO_Wb[i] * this->vertical_coeficients[this->ProbeNumbers[i]];
			...
			*/
			...
			outputstruct[0].Magnetics_SVD_recons_0 = Bmag_rec_corr[0];
			outputstruct[0].Magnetics_SVD_recons_1 = Bmag_rec_corr[1];
			outputstruct[0].Magnetics_SVD_recons_2 = Bmag_rec_corr[2];
			outputstruct[0].Magnetics_SVD_recons_3 = Bmag_rec_corr[3];
			outputstruct[0].Magnetics_SVD_recons_4 = Bmag_rec_corr[4];
			outputstruct[0].Magnetics_SVD_recons_5 = Bmag_rec_corr[5];
			outputstruct[0].Magnetics_SVD_recons_6 = Bmag_rec_corr[6];
			outputstruct[0].Magnetics_SVD_recons_7 = Bmag_rec_corr[7];
			outputstruct[0].Magnetics_SVD_recons_8 = Bmag_rec_corr[8];
			outputstruct[0].Magnetics_SVD_recons_9 = Bmag_rec_corr[9];
			outputstruct[0].Magnetics_SVD_recons_10 = Bmag_rec_corr[10];
			outputstruct[0].Magnetics_SVD_recons_11 = Bmag_rec_corr[11];
			//end
