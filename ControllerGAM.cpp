			...
			if (inputstruct[0].PrimaryWaveformMode == 7 || inputstruct[0].HorizontalWaveformMode == 7 || inputstruct[0].VerticalWaveformMode == 7){
				...
				if (inputstruct[0].HorizontalWaveformMode == 2){
					...
					if (inputstruct[0].PrimaryCurrent < -25 && inputstruct[0].PlasmaCurrent < -750) {
						...
						//outputstruct[0].SendToHorizontalValue = this->vertical_position_PID->CalculatePID_sign( inputstruct[0].PositionZ, inputstruct[0].HorizontalOutputWaveform/1000,2);
					}
					if (inputstruct[0].PrimaryCurrent > 25 && inputstruct[0].PlasmaCurrent > 750) {
						outputstruct[0].SendToHorizontalValue = this->vertical_position_PID->CalculatePID(inputstruct[0].PositionZ, inputstruct[0].HorizontalOutputWaveform/1000);
					}
					// else: keep the output (no changes)
